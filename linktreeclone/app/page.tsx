...
export default function Home() {
  ...
  return (
    <div className="bg-[#254f1a] min-h-[100vh] ">
       <ToastContainer />
    <section className="grid grid-cols-2  items-center min-h-[100vh] py-40">
      <div className= "ml-10">
        <div>
           ...
           <TypeAnimation
        sequence={[
          "Everything you are. In one, simple link in bio.", // text
          1000, // wait 1s after finishing
        ]}
        wrapper="p"
        speed={10} // typing speed (lower = faster)
        className="text-6xl font-extrabold text-[#d2e823]"
        repeat={0} // 0 = no loop
      />
           </div>
